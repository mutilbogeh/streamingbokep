    ...
    const file = data.result[0];
        ...
        publisher: {
            ...
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://streamingbokep.pages.dev'
              },
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://streamingbokep.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd3 = {
